  ...
  return {
    ...
    index: {
      ...
      candidates: questions.map((question, index) => ({
        ...
        playbackContentId: `listening-playback-v1-0000000${index + 1}`,
        knowledgePointId: `knowledge-v1-listening-0000000${index + 1}`,
        semanticCategoryId: `semantic-v1:test-${index + 1}`,
        domain: 'listening',
  ...
  return {
    ...
    index: {
      ...
      candidates: prompts.map((prompt, index) => ({
        ...
        knowledgePointId: `knowledge-v1-speaking-${index + 1}`,
        semanticCategoryId: `semantic-v1:test-${index + 1}`,
        domain: 'speaking',
