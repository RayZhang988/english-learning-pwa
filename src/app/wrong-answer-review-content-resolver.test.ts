...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 1926 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(1926)
    ...
    expect(counts).toEqual({ vocabulary: 1551, listening: 253, speaking: 122 })
  })
})
