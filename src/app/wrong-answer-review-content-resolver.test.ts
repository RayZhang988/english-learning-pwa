...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 11525 released v2 aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(11525)
    ...
    expect(counts).toEqual({ vocabulary: 9612, listening: 1013, speaking: 900 })
