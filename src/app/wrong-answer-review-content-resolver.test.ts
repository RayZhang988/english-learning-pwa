...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 6033 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(6033)
    ...
    expect(counts).toEqual({ vocabulary: 5658, listening: 253, speaking: 122 })
  }, 15_000)
})
