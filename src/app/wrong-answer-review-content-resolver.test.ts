...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 4944 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(4944)
    ...
    expect(counts).toEqual({ vocabulary: 4569, listening: 253, speaking: 122 })
  })
})
