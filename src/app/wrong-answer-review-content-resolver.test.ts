...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 5649 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(5649)
    ...
    expect(counts).toEqual({ vocabulary: 5274, listening: 253, speaking: 122 })
  })
})
