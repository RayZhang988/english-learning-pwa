...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 4110 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(4110)
    ...
    expect(counts).toEqual({ vocabulary: 3735, listening: 253, speaking: 122 })
  })
})
