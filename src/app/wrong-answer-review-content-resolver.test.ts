...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 2076 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(2076)
    ...
    expect(counts).toEqual({ vocabulary: 1701, listening: 253, speaking: 122 })
  })
})
