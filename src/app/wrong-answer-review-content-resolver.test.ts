...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 4779 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(4779)
    ...
    expect(counts).toEqual({ vocabulary: 4404, listening: 253, speaking: 122 })
  })
})
