...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 1701 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(1701)
    ...
    expect(counts).toEqual({ vocabulary: 1326, listening: 253, speaking: 122 })
  })
})
