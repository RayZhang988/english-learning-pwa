...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 6432 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(6432)
    ...
    expect(counts).toEqual({ vocabulary: 6057, listening: 253, speaking: 122 })
  }, 15_000)
})
