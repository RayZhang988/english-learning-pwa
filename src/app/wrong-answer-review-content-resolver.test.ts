...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 7023 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(7023)
    ...
    expect(counts).toEqual({ vocabulary: 6648, listening: 253, speaking: 122 })
  }, 15_000)
})
