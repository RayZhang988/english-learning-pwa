...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 2661 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(2661)
    ...
    expect(counts).toEqual({ vocabulary: 2286, listening: 253, speaking: 122 })
  })
})
