...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 3033 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(3033)
    ...
    expect(counts).toEqual({ vocabulary: 2658, listening: 253, speaking: 122 })
  })
})
