...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 5460 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(5460)
    ...
    expect(counts).toEqual({ vocabulary: 5085, listening: 253, speaking: 122 })
  })
})
