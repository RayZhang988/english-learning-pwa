...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 2847 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(2847)
    ...
    expect(counts).toEqual({ vocabulary: 2472, listening: 253, speaking: 122 })
  })
})
