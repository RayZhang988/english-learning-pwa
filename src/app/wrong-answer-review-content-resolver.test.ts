...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 6231 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(6231)
    ...
    expect(counts).toEqual({ vocabulary: 5856, listening: 253, speaking: 122 })
  }, 15_000)
})
