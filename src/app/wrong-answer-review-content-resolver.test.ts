...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 5838 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(5838)
    ...
    expect(counts).toEqual({ vocabulary: 5463, listening: 253, speaking: 122 })
  }, 15_000)
})
