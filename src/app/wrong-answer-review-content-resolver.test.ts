...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 4443 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(4443)
    ...
    expect(counts).toEqual({ vocabulary: 4068, listening: 253, speaking: 122 })
  })
})
