...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 3408 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(3408)
    ...
    expect(counts).toEqual({ vocabulary: 3033, listening: 253, speaking: 122 })
  })
})
