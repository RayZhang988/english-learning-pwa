...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 10002 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(10002)
    ...
    expect(counts).toEqual({ vocabulary: 9627, listening: 253, speaking: 122 })
  }, 15_000)
})
