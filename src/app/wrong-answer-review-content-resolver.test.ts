...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 5106 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(5106)
    ...
    expect(counts).toEqual({ vocabulary: 4731, listening: 253, speaking: 122 })
  })
})
