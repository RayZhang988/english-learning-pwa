...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 4611 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(4611)
    ...
    expect(counts).toEqual({ vocabulary: 4236, listening: 253, speaking: 122 })
  })
})
