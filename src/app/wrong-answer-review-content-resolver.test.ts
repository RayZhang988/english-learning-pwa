...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 5268 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(5268)
    ...
    expect(counts).toEqual({ vocabulary: 4893, listening: 253, speaking: 122 })
  })
})
