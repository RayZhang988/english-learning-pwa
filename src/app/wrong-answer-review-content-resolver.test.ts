...
describe('R13-D production review resolver coverage', () => {
  it('resolves every one of the 4275 released aliases without probing answers', async () => {
    ...
    expect(aliases).toHaveLength(4275)
    ...
    expect(counts).toEqual({ vocabulary: 3900, listening: 253, speaking: 122 })
  })
})
