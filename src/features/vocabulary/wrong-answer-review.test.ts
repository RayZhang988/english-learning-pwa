...
const supply: VocabularySupplyItem = { schemaVersion: 1, itemId: 'supply-1', knowledgePointId: 'knowledge-term', semanticCategoryId: 'semantic-travel-document', learningUnitId: 'unit', contentRef: 'lesson://unit', difficultyLevel: 2, tags: [], domain: 'vocabulary', targetModuleId: 'vocabulary', source: { sourceType: 'vocabulary-item', sourceId: 'term', variantId: 'term-to-meaning-choice', distractorItemIds: ['a', 'b'] } }
