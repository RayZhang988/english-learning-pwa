...
const rows = [
  ...
  ['excuse me', '劳驾', 'politeness phrase', 'Excuse me, where is the hotel?', '劳驾，酒店在哪里？'],
  ['yes', '是的', 'response word', 'Yes, this is my bag.', '是的，这是我的包。'],
  ['no', '不', 'response word', 'No, I do not understand.', '不，我不明白。'],
  ...
  ['stop', '停下', 'verb', 'Please stop here.', '请在这里停下。'],
  ['go', '去', 'verb', 'Go to the hotel.', '去酒店。'],
  ...
  ['room key', '房间钥匙', 'noun phrase', 'Here is your room key.', '这是你的房间钥匙。'],
  ...
  ['open', '营业中', 'adjective', 'Is the store open?', '商店在营业吗？'],
