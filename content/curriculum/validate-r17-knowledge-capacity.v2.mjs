...
assert.equal(audit.source.dailyVocabularySourceCount, 1096)
assert.equal(audit.current.dailyKnowledgePointCount, 1091)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1091)
