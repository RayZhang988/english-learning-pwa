...
assert.equal(audit.source.dailyVocabularySourceCount, 682)
assert.equal(audit.current.dailyKnowledgePointCount, 677)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 677)
