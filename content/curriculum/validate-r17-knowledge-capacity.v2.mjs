...
assert.equal(audit.source.dailyVocabularySourceCount, 1373)
assert.equal(audit.current.dailyKnowledgePointCount, 1368)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1368)
