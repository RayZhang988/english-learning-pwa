...
assert.equal(audit.source.dailyVocabularySourceCount, 558)
assert.equal(audit.current.dailyKnowledgePointCount, 553)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 553)
