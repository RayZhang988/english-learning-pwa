...
assert.equal(audit.source.dailyVocabularySourceCount, 1617)
assert.equal(audit.current.dailyKnowledgePointCount, 1612)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1612)
