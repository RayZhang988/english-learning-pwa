...
assert.equal(audit.source.dailyVocabularySourceCount, 1041)
assert.equal(audit.current.dailyKnowledgePointCount, 1036)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1036)
