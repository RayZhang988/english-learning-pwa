...
assert.equal(audit.source.dailyVocabularySourceCount, 1152)
assert.equal(audit.current.dailyKnowledgePointCount, 1147)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1147)
