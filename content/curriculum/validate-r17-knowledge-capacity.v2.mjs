...
assert.equal(audit.source.dailyVocabularySourceCount, 931)
assert.equal(audit.current.dailyKnowledgePointCount, 926)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 926)
