...
assert.equal(audit.source.dailyVocabularySourceCount, 2012)
assert.equal(audit.current.dailyKnowledgePointCount, 2007)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 2007)
