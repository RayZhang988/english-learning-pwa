...
assert.equal(audit.source.dailyVocabularySourceCount, 1815)
assert.equal(audit.current.dailyKnowledgePointCount, 1810)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1810)
