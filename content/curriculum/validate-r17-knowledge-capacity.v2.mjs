...
assert.equal(audit.source.dailyVocabularySourceCount, 620)
assert.equal(audit.current.dailyKnowledgePointCount, 615)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 615)
