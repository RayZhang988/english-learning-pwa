...
assert.equal(audit.source.dailyVocabularySourceCount, 238)
assert.equal(audit.current.dailyKnowledgePointCount, 233)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 233)
