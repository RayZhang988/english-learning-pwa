...
assert.equal(audit.source.dailyVocabularySourceCount, 1319)
assert.equal(audit.current.dailyKnowledgePointCount, 1314)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1314)
