...
assert.equal(audit.source.dailyVocabularySourceCount, 807)
assert.equal(audit.current.dailyKnowledgePointCount, 802)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 802)
