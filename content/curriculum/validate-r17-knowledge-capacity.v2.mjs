...
assert.equal(audit.source.dailyVocabularySourceCount, 1208)
assert.equal(audit.current.dailyKnowledgePointCount, 1203)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1203)
