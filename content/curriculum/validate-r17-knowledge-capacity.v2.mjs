...
assert.equal(audit.source.dailyVocabularySourceCount, 493)
assert.equal(audit.current.dailyKnowledgePointCount, 488)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 488)
