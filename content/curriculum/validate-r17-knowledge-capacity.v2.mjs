...
assert.equal(audit.source.dailyVocabularySourceCount, 986)
assert.equal(audit.current.dailyKnowledgePointCount, 981)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 981)
