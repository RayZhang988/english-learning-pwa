...
assert.equal(audit.source.dailyVocabularySourceCount, 869)
assert.equal(audit.current.dailyKnowledgePointCount, 864)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 864)
