...
assert.equal(audit.source.dailyVocabularySourceCount, 363)
assert.equal(audit.current.dailyKnowledgePointCount, 358)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 358)
