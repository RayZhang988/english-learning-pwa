...
assert.equal(audit.source.dailyVocabularySourceCount, 745)
assert.equal(audit.current.dailyKnowledgePointCount, 740)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 740)
