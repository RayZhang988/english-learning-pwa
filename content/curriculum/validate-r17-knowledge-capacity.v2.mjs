...
assert.equal(audit.source.dailyVocabularySourceCount, 1748)
assert.equal(audit.current.dailyKnowledgePointCount, 1743)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1743)
