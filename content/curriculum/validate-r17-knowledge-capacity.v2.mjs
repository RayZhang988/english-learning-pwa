...
assert.equal(audit.source.dailyVocabularySourceCount, 428)
assert.equal(audit.current.dailyKnowledgePointCount, 423)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 423)
