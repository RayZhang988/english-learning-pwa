...
assert.equal(audit.source.dailyVocabularySourceCount, 313)
assert.equal(audit.current.dailyKnowledgePointCount, 308)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 308)
