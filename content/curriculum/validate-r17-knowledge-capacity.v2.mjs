...
assert.equal(audit.source.dailyVocabularySourceCount, 3005)
assert.equal(audit.current.dailyKnowledgePointCount, 3000)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 3000)
