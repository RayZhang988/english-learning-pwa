...
assert.equal(audit.source.dailyVocabularySourceCount, 1491)
assert.equal(audit.current.dailyKnowledgePointCount, 1486)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1486)
