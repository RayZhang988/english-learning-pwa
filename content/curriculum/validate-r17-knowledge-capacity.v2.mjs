...
assert.equal(audit.source.dailyVocabularySourceCount, 1427)
assert.equal(audit.current.dailyKnowledgePointCount, 1422)
...
assert.equal(audit.levelCapacity.levels.reduce((total, level) => total + level.currentDailyKnowledgePoints, 0), 1422)
