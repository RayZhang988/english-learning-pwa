...
**自然单 voice 候选的正式自动化与真实用户听感门槛通过；第一版整体仍未通过。**
...
| G5 设备与语音 | 待真机 | QA-007 的真实用户听感已通过；麦克风、录音、权限、后台与完整系统语音真机项尚未全部验证，且用户另报口语问题但尚未提供可登记证据 |
...
阶段性结论：**听力正式自动化与真实用户听感门槛已通过；第一版整体仍未通过。**

下一步顺序：

1. 取得用户所报口语新问题的环境、最短复现步骤、实际结果和影响，再登记、定级并
   派回责任任务；信息不足时不得猜测缺陷编号或结论。
2. 完成其余 iPhone 安装、离线、权限、后台、恢复和无障碍清单。
3. 只有完整真机门槛通过后，才开始连续 14 天记录。
